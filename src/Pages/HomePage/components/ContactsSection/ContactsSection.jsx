...
const ContactsSection = () => {
  return (
    <section
      className={`section relative ${scss.contactsSection} pb-48 xlg:pt-28`}
    >
      <div className={`container md:flex md:justify-between`}>
        ...
        <div className="mt-52 md:mt-24 xlg:mt-28">
          <ul className={`ml-20 mb-20 sm:ml-32 lg:ml-0 lg:pr-28`}>
            <li>
          ...
          <SocialsList className="ml-20 font-bold sm:ml-32 lg:ml-0 lg:pr-28"></SocialsList>
          <div
            className={`${scss.sectionBg} absolute -z-50 -right-14 bottom-24 xlg:-right-7`}
          >
            <Icon
              id={"contacts-bg"}
